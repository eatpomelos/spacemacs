;;; packages.el --- pomelo-better-defaults layer packages file for Spacemacs.
;;
;; Copyright (c) 2012-2017 Sylvain Benner & Contributors
;;
;; Author: Ubuntu14.04LTS <pomelo@ubuntu>
...
(defconst pomelo-better-defaults-packages
  '()
  "The list of Lisp packages required by the pomelo-better-defaults layer.
